...
const Youtubeservices = () => {
  ...
  return (
    <section className='mt-[200px]  
      ...
      <Container className='pt-[24px] flex justify-center flex-col pb-[40px]'>
        <div className='  flex justify-center '>
          <div className='flex gap-x-4 rounded-[5px]  items-center px-[16px] py-[8px] text-[14px] bg-[#EDF2F7]'>
            <p className='text-[14px] font-bold'>  BUY YOUTUBE VIEWS</p>
          </div>

        </div>
        <div className='  flex justify-center pt-[20px] '>
          <div className='flex gap-x-4   items-center px-[16px] py-[8px]  '>
            <div className='flex items-center gap-x-2'>  <p className='text-[36px] font-bold text-[#4C4C4C]'>
              Buy Youtube Views with </p>
              <p className='text-[36px] font-bold text-[#B67929]'> Fast Delivery </p>
            </div>
          </div>
        ...
        <div className='  flex justify-center '>
          <div className='flex gap-x-4   items-center px-[16px] py-[8px]  '>
            <div className='flex items-center gap-x-2'>
              <p className='text-[23px]  text-[#2D3748]'>
                With SidesMedia you can </p>
              <p className='text-[23px] font-bold text-[#2D3748]'> easily buy Youtube Views safely </p>
              <p className='text-[23px]  text-[#2D3748]'>
                and securely.
              </p>
            </div>
        ...
        <div className='  flex justify-center '>
          <div className='flex gap-x-4   items-center px-[16px] py-[8px]  '>
            <div className='px-[12px] py-[6px] bg-[#F8F9FA] rounded-[5px]'>
              <div onClick={() => setOpen(!open)} className='w-[500px] flex justify-between px-[12px] py-[6px] bg-[#F8F9FA] '>
        ...
        <div className='hover:mt-0 transition-[margin_0.6s_ease_0s] mt-[8px] pb-[48px]'>
          <div className='  flex justify-center  '>
        ...
        <div className='  flex justify-center  '>
          <div className='flex justify-between gap-x-[40px] rounded-[12px] border border-[#B67929] items-center px-[20px] py-[20px] text-[14px] '>
      ...
      <Container className="  bg-[#eaeef3] py-[64px] w-full">
        <div className='flex flex-col'>
          <div className=' flex justify-center gap-x-2 text-[16px] 
            ...
            <p className='text-[30px] text-[#454545]'>
              Ready To Buy  </p>
            <p className='text-[30px] text-[#B67929]'>
              YouTube Views? </p>
          </div>
      ...
      <Container className="md:px-40 py-40  bg-[#18213e]">
        <div className='flex justify-center flex-col gap-y-8'>
          <div className='flex justify-center text-[#3D67FF] '>
            WEB • EXTENSION • APP
          </div>
          <div className='flex justify-center flex-col text-center text-[38px] text-[white]'>
          ...
          <div className='flex justify-center gap-x-28'>
            ...
            <div className='flex flex-col pt-8 gap-y-6'>
              <div className='flex justify-center flex-col text-[30px] font-bold text-[white]'>
                <p>Understand what’s</p>
                <p>working for your channel</p>
              </div>
              <div className='flex justify-center w-[400px] text-[17px] text-[#BCBCBC]'>
      ...
      <Container className="md:px-40 py-40  bg-[#18213e]">
        <div className='flex justify-center flex-col '>
          ...
          <div className='flex justify-center flex-col text-center text-[16px] text-[#BCBCBC] py-4'>
      ...
      <Container className="px-[80px] py-40  bg-[#060607]">
        <div className='flex justify-center flex-col '>
          <div className='flex justify-center text-[28px] gap-x-2 text-[white] '>
            Now with <p className='text-[#07E092]'> artificial intelligence </p> baked in
          </div>

          <div className='bg-[#18112E] mt-[80px] rounded-[15px] px-[20px] py-[64px]'>
            <div className='flex justify-center items-center gap-x-20'>
              <div className='flex flex-col text-white '>
                <div className='text-[16px]'>YOUR A.I. CO-PILOT</div>
                <div className='my-[16px] flex flex-col text-[24px] text-white'>
                ...
                <div className='flex gap-x-4 items-center my-[16px]'>
                  ...
                  <p className='text-[18px]'>Save hours researching</p>
                </div>
                ...
                <div className='flex gap-x-4 items-center my-[16px]'>
                  ...
                  <p className='text-[18px]'>See into the future</p>
                </div>
                <div className='flex flex-col text-[16px] text-[#AC9EB8] mt-[8px] '>
                ...
                <div className='flex gap-x-4 items-center my-[16px]'>
                  <BiRocket size={20} />
                  <p className='text-[18px]'>Break new ground</p>
                </div>
                <div className='flex flex-col text-[16px] text-[#AC9EB8] mt-[8px] '>
              ...
              <div className='flex flex-col gap-y-6'>
                <Fade right>
                  <div className='bg-gradient-to-r flex-col from-[#ff4273] to-[#ff8c5a] rounded-[10px] px-[100px] py-[32px] flex justify-center items-center'>
                    <div className='flex bg-[#FFFFFF66] text-[#000000] text-[14px] px-[16px] rounded-full'>
                      View Prediction 🚀 Very High
                    </div>
                    <div className='flex mt-[16px] text-[#FFFFFF] text-[24px]'>
                      get more views fast
                    </div>
                ...
                <Fade right>
                  <div className='bg-gradient-to-r flex-col from-[#2fbae5] to-[#70eb7c] rounded-[10px] px-[100px] py-[32px] flex justify-center items-center'>
                    <div className='flex bg-[#FFFFFF66] text-[#000000] text-[14px] px-[16px] rounded-full'>
                ...
                <Fade right>
                  <div className='bg-gradient-to-r flex-col from-[#3d67ff] to-[#93ede8] rounded-[10px] px-[100px] py-[32px] flex justify-center items-center'>
                    <div className='flex bg-[#FFFFFF66] text-[#000000] text-[14px] px-[16px] rounded-full'>
      ...
      <Container className="md:px-40 py-20  bg-[#060607]">
        <div className='flex justify-center flex-col '>
          <div className='flex justify-center text-[30px] text-[white] '>
            <Image src="/images/logo.png" width={100} height={80} alt='fund' />
          </div>
          <div className='flex justify-center flex-col text-center text-[56px] text-[white] py-4'>
            <p>Supercharge your YouTube <br /> channel today</p>
          </div>
          <div className='flex justify-center flex-col text-center text-[22px] text-[#8B98B4] py-4'>
